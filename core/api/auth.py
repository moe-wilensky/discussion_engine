...
def request_verification(request):
    ...
    try:
        verification_id, success, message = PhoneVerificationService.send_verification_code(
            phone_number
        )
        
        expires_at = timezone.now() + timedelta(minutes=PhoneVerificationService.CODE_EXPIRY_MINUTES)
        
        response_serializer = PhoneVerificationResponseSerializer(data={
