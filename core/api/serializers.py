...
from core.models import (
    User, Invite, Discussion, JoinRequest, DiscussionParticipant,
    Round, Response, ResponseEdit, DraftResponse
)
...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'platform_invites_acquired', 'platform_invites_used', 'platform_invites_banked',
            'discussion_invites_acquired', 'discussion_invites_used', 'discussion_invites_banked',
            'created_at'
        ]
...
class InviteSerializer(serializers.ModelSerializer):
    ...
    discussion_headline = serializers.CharField(source='discussion.topic_headline', read_only=True)
    
    class Meta:
        model = Invite
        fields = [
            'id', 'invite_type', 'status',
            'inviter', 'inviter_username',
            'invitee', 'invitee_username',
            'discussion', 'discussion_headline',
            'sent_at', 'accepted_at', 'first_participation_at'
        ]
...
class JoinRequestSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'requester_platform_invites', 'requester_discussion_invites'
        ]
...
class JoinRequestActionSerializer(serializers.Serializer):
    ...
    response_message = serializers.CharField(required=False, allow_blank=True, max_length=500)
...
class DiscussionSummarySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Discussion
        fields = [
            'id', 'topic_headline', 'topic_details', 'status',
            'created_at', 'participant_count', 'response_count'
        ]
...
class DiscussionParticipantSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'observer_since', 'observer_reason', 'can_invite_others'
        ]
...
class RoundInfoSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Round
        fields = [
            'round_number', 'status', 'phase', 'start_time', 'end_time',
            'responses_count', 'responses_needed_for_phase_2',
            'mrp_minutes', 'mrp_deadline'
        ]
...
class DiscussionDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'parameters', 'participants', 'current_round',
...
class ResponseSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'character_count', 'created_at', 'last_edited_at',
            'edit_count', 'time_since_previous_minutes',
            'response_number', 'quotes'
        ]
