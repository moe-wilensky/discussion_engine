...
from core.models import (
    User, Round, Response, ResponseEdit, DraftResponse, 
    PlatformConfig, DiscussionParticipant
)
...
class ResponseService:
    ...
    def calculate_edit_budget(response: Response, config: PlatformConfig) -> int:
        ...
        """
        max_changeable = (response.character_count * config.response_edit_percentage) // 100
