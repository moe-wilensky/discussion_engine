...
from core.models import User, Invite, Discussion, DiscussionParticipant, PlatformConfig, Response
...
class TestInviteService:
    ...
    def test_send_platform_invite_consumption_sent(self, user_factory, response_factory):
    ...
    def test_send_discussion_invite(self, user_factory, discussion_factory, response_factory):
    ...
    def test_send_discussion_invite_not_participant(self, user_factory, discussion_factory):
    ...
    def test_send_discussion_invite_already_participant(
        ...
        DiscussionParticipant.objects.create(discussion=discussion, user=inviter, role='active')
        DiscussionParticipant.objects.create(discussion=discussion, user=invitee, role='active')
    ...
    def test_accept_invite_consumption_accepted(self, user_factory, response_factory):
        ...
        new_user = User.objects.create_user(username='newuser', phone_number='+19998887777')
        InviteService.accept_invite(invite, new_user)
...
class TestInviteAPI:
    ...
    def test_my_invites_endpoint(self, authenticated_client, user_factory, response_factory):
    ...
    def test_send_platform_invite_endpoint(self, authenticated_client, response_factory):
