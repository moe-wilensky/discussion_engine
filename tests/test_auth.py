...
class TestPhoneVerification:
    ...
    def test_rate_limiting(self, user_factory):
        ...
        cache.set(
            rate_key, PhoneVerificationService.MAX_REQUESTS_PER_WINDOW, timeout=3600
        )
...
class TestAuthenticationAPI:
    ...
    def test_registration_with_invite(
    ...
    def test_registration_without_invite(self, api_client):
        ...
        response = api_client.post(
            "/api/auth/register/verify/",
            {"verification_id": verification_id, "code": code, "username": "newuser2"},
        )
    ...
    def test_login_flow(self, api_client, user_factory):
        ...
        # Request login
        response = api_client.post("/api/auth/login/", {"phone_number": "+12345678900"})
