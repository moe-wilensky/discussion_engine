...
class TestJoinRequestAPIErrors:
    ...
    def test_create_join_request_invalid_discussion(self, authenticated_client):
        ...
        response = authenticated_client.post('/api/discussions/999999/join-request/', {
    ...
    def test_approve_join_request_invalid_id(
        ...
        response = authenticated_client.post(
            f'/api/join-requests/999999/approve/'
        )
    ...
    def test_decline_join_request_invalid_id(
        ...
        response = authenticated_client.post(
            f'/api/join-requests/999999/decline/'
        )
...
class TestValidationErrors:
    ...
    def test_discussion_invite_with_string_ids(self, authenticated_client):
        ...
        response = authenticated_client.post('/api/invites/discussion/send/', {
            'discussion_id': 'not-an-int',
            'invitee_user_id': 'also-not-an-int'
        })
